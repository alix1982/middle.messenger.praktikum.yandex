...
export function chatsHtml() {
    ...
    function openMessege(e: Event, item: HTMLButtonElement) {
        ...
        const buttonSubmitMessege = document.querySelector('.chatContent__controlButton') as HTMLButtonElement;
    ...
    arrChatsElements.forEach((item: HTMLButtonElement) => item.addEventListener('click', (e) => {openMessege(e, item)}));
